...
class Onchain:
    ...
    def swap(self, src_token: Token, dst_token: Token, amount: Amount | int | float) -> str:
        ...
        swap_factory_contract = self.get_contract('0xd394e9cc20f43d2651293756f8d320668e850f1b',
        ...
        contract = self.get_contract('0x6947a425453d04305520e612f0cb2952e4d07d62', 'arbswap_uni_router')
