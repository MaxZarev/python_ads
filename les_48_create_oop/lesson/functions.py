...
def find_element(driver: webdriver.Chrome, xpath: str) -> WebElement | None:
    """
    Find element by xpath without exception
    :param driver:  драйвер браузера
    :param xpath:  xpath элемента
    :return: вэб элемент или None
    """
    try:
...
def click_element(driver: webdriver.Chrome, xpath: str) -> bool:
    """
    Click element by xpath without exception
    :param driver: драйвер браузера
    :param xpath: xpath элемента
    :return: результат клика
    """
...
browser_1 = start_profile(700)
browser_2 = start_profile(701)

browser_1.get("https://google.com")
browser_2.get("https://google.com")