...
'''
print("Hello, Brayan, My name is Max, I have 1000 accs LayerZero")
print("I want airdrop 1000$ for every acc")
print("Give me my drop = 1000$ * 1000 accs = 1000000$")
print("I want to buy Lambo, lambo price 300000$")
print("I want to buy 3 Lambo")
