...
class Onchain:
    ...
    def send_eth(self, amount: Amount, to_address: str | ChecksumAddress) -> str:
        ...
        tx_params = self.prepare_tx(amount, to_address)
    ...
    def send_usdt_manual(self, amount: Amount, to_address: str | ChecksumAddress) -> str:
        """
        Отправка токена USDT
        :param amount: объект Amount с суммой
        :param to_address: адрес получателя
        ...
        balance = self.get_balance('0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9')
        ...
        data = contract.encode_abi('transfer', dict(_to=to_address, _value=amount.wei))
