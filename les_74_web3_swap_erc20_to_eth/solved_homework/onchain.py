...
class Onchain:
    ...
    def send_token(self, amount: Amount, to_address: str | ChecksumAddress,
        ...
        hash = self.sing_and_send(tx, message)
        return hash
    ...
    def approve(self, token: Token, amount: Amount | int | float,
        ...
        self.sing_and_send(tx, message)

    def sing_and_send(self, tx: dict, message: str = '') -> str:
        """
        ...
        print(f'Транзакция отправлена {message} tx hash: {tx_receipt.transactionHash.hex()}')
