...
# задание 2
"""
Напишите программу, которая генерирует цену на газ (от 10 до 40) и начальный баланс кошелька (от 2000 до 10000)
...
gas_price = random.randint(10, 41)  # генерация цены на газ
balance = random.randint(2000, 10001)  # генерация баланса кошелька
